%-------------------------------------
%Riera & Melian JUNE 2017
%Metacommunity Leslie Matrix Dynamics
%-------------------------------------

%---------Ali-s intro Agents.jl package
%https://github.com/kavir1698/Agents.jl
%--------------------------------------
%Space
%Life cycle :: 6 :: Births and deaths :: functions assotiated to agents' state :: Biotic Abiotic Mating Dispersal
%Individuals change during their lifetime :: difference with cocon 
...
%Space :: Import distance graph as matrix
%S = X;%Sites
